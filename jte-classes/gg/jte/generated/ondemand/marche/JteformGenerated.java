	...
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, BindingResult bindingResult, MarcheDTO marcheDTO, Map<String, String> messages, List<TypesMarche> typeMarcheList, List<Imputation> imputationList, List<AutoriteContractante> autoriteContractanteList, List<AutoriteContractanteStructures> structureAutoriteContractanteList, List<ModesPassation> modePassationList) {
		...
		gg.jte.generated.ondemand.JtelayoutGenerated.render(jteOutput, jteHtmlInterceptor, "Nouveau Marché", new gg.jte.html.HtmlContent() {
			public void writeTo(gg.jte.html.HtmlTemplateOutput jteOutput) {
				...
				jteOutput.writeContent("\n                    <div class=\"form-section-title\">01. Informations Générales</div>\n                    <div class=\"row g-4 mb-5\">\n                        <div class=\"col-md-6\">\n                            <label class=\"form-label small fw-bold\">Numéro provisoire du marché</label>\n                            <input type=\"text\" class=\"form-control\" name=\"numMarche\" placeholder=\"Ex: M-001\"");
				var __jte_html_attribute_0 = marcheDTO.getNumMarche();
				...
				var __jte_html_attribute_1 = marcheDTO.getImputation() == null;
				...
				for (var el: imputationList) {
					jteOutput.writeContent("\n                                    <option");
					var __jte_html_attribute_2 = marcheDTO.getImputation() != null && marcheDTO.getImputation().equals(el.getImputation());
					if (__jte_html_attribute_2) {
					jteOutput.writeContent(" selected");
					}
					var __jte_html_attribute_3 = el.getImputation();
				...
				jteOutput.writeContent("\n                            </select>\n                        </div>\n\n                    </div>\n\n\n\n                    ");
				jteOutput.writeContent("\n                    <div class=\"form-section-title\">02. Caractéristiques du marché </div>\n                    <div class=\"row g-4 mb-5\">\n                                                <div class=\"col-md-12\">\n                                                    <label class=\"form-label small fw-bold\">Titulaire du marché</label>\n                                                    <input type=\"text\" class=\"form-control\" name=\"titulaireMarche\" placeholder=\"Nom de l'entreprise\"");
				var __jte_html_attribute_4 = marcheDTO.getTitulaireMarche();
				...
				var __jte_html_attribute_5 = marcheDTO.getTypeMarcheCode() == null;
				...
				for (var el: typeMarcheList) {
					jteOutput.writeContent("\n                                    <option");
					var __jte_html_attribute_6 = marcheDTO.getTypeMarcheCode() != null && marcheDTO.getTypeMarcheCode().equals(el.getCode());
				...
				var __jte_html_attribute_8 = marcheDTO.getModePassationCode() == null;
				...
				for (var el: modePassationList) {
					jteOutput.writeContent("\n                                    <option");
					var __jte_html_attribute_9 = marcheDTO.getModePassationCode() != null && marcheDTO.getModePassationCode().equals(el.getCode());
				...
				var __jte_html_attribute_11 = marcheDTO.getAutoriteContractanteCode() == null;
				...
				for (var el: autoriteContractanteList) {
					jteOutput.writeContent("\n                                    <option");
					var __jte_html_attribute_12 = marcheDTO.getAutoriteContractanteCode() != null && marcheDTO.getAutoriteContractanteCode().equals(el.getCode());
				...
				var __jte_html_attribute_14 = marcheDTO.getStructureAutoriteContractanteCode() == null;
				...
				for (var el: structureAutoriteContractanteList) {
					jteOutput.writeContent("\n                                    <option");
					var __jte_html_attribute_15 = marcheDTO.getStructureAutoriteContractanteCode() != null && marcheDTO.getStructureAutoriteContractanteCode().equals(el.getCode());
					if (__jte_html_attribute_15) {
					jteOutput.writeContent(" selected");
					}
					var __jte_html_attribute_16 = el.getCode();
				...
				var __jte_html_attribute_17 = marcheDTO.getApprouvePar();
